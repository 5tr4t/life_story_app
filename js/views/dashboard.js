function renderDashboard(navigateTo, state) {
        ...
        <nav class="navbar">
            <div class="container flex justify-between items-center">
                <div class="flex items-center gap-sm">
                    <h2 style="font-size: 1.25rem;">Life Story</h2>
                </div>
    ...
    const setupBtnClass = setupActive ? 'btn-accent' : 'btn-primary';
    ...
    const outlineBtnClass = outlineActive ? 'btn-accent' : 'btn-primary';
    ...
    const interviewBtnClass = interviewsActive ? 'btn-accent' : 'btn-primary';
    ...
    const reviewBtnClass = reviewActive ? 'btn-accent' : 'btn-primary';
    ...
    const main = `
        <main class="container" style="padding-top: 3rem; padding-bottom: 3rem;">
            ...
            <div style="background: linear-gradient(135deg, #dcfce7 0%, #d1fae5 100%); border: 2px solid #166534; border-radius: 1rem; padding: 3rem; text-align: center; margin-bottom: 3rem;">
                ...
                <p style="font-size: 1.25rem; color: #166534; margin-bottom: 0;">Your life story memoir is complete!</p>
            </div>
            ` : ''}
